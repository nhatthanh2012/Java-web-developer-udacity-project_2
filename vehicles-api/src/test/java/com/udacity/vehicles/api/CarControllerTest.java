...
public class CarControllerTest {
    ...
    public void deleteCar() throws Exception {
        ...
        // test list car null after delete car
        mvc.perform(delete(new URI("/cars/1"))
                        .content("{}"))
                .andExpect(status().isNoContent());
        // ThanhTLN add end - 20231025
     ...
     * Description: test update car
     */
    @Test public void updateCar() throws Exception  {
        Car car = getCar();
        car.setId(1L);
